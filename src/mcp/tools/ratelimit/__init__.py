"""
MCP Namespace: ratelimit

Rate-limiting utilities and tools.

Exposed tools
-------------
- manage : inspect, enable/disable, and tune rate-limit settings
...
TOOLS: dict[str, str] = {
    "manage": "src.mcp.tools.ratelimit.manage",
}
...
def get_tool(name: str) -> Callable[..., Any]:
    ...
    try:
        ...
        raise KeyError(f"Unknown ratelimit tool: {name}") from e
