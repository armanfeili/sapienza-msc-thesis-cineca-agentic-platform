"""
MCP Namespace: privacy

Privacy-related utilities and tools.

Exposed tools
-------------
- consent : read/write user consent flags and generate consent prompts
...
TOOLS: dict[str, str] = {
    "consent": "src.mcp.tools.privacy.consent",
}
...
def get_tool(name: str) -> Callable[..., Any]:
    ...
    try:
        ...
        raise KeyError(f"Unknown privacy tool: {name}") from e
